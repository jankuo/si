...
define('APP_FLAG_VER',	'0606152851');
/// MC　KEY　的前缀
...
if (XWB_SERVER_ENV_TYPE!=='sae'){
    ...
    /// 微博 APP_KEY
    define('WB_AKEY', 			'4291621393');
    /// 微博 SECRET_KEY
    define('WB_SKEY', 			'14104b07fb090fcd3522aa88815bc786');
    /// 官方微博功能中创建list使用的ID
    define('SYSTEM_SINA_UID',	'');
    /// 内置设置的token
    define('WB_USER_OAUTH_TOKEN',			'3443c22f099bcddf7bbc71e1ef570ec0');
    define('WB_USER_OAUTH_TOKEN_SECRET',	'3ba978a3eaf0f6ff141d7a1647621a12');
    
    /// 安装时的站长个人信息
    define('WB_USER_SITENAME',		'ss');
    define('WB_USER_SITEINFO',		'ss');
    define('WB_USER_NAME',			'以下资料将');
    define('WB_USER_EMAIL',			'33@456.com');
    define('WB_USER_QQ',			'1111111111');
    define('WB_USER_MSN',			'11111111111');
    define('WB_USER_TEL',			'155211111111');
}
//----------------------------------------------------------------------
...
/// MC 的 HOST 配置
define('MC_HOST', '172.16.245.91:22222');
//----------------------------------------------------------------------
/// DB　相关的配置
define('DB_PORT',		'3306');
...
define('DB_PREFIX',		'xwb22_');
//define('DB_NAME',		'xweibo');
define('DB_NAME',		'xweibo');
//----------------------------------------------------------------------
...
define('PAGE_TYPE_CURRENT', 'default');
